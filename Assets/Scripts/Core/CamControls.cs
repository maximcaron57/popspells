...
namespace Assets.Scripts.Core
{
    public class CamControls : MonoBehaviour
    {
        ...
        public struct CamControlsParam
        {
            ...
            public float camHeightAdjustmentMaxSpeed;
        }

        public CamControls(CamControlsParam CamControlArgs)
        {
            _transform.position = CamControlArgs.position;
            _transform.rotation = CamControlArgs.orientation;
            _speed = CamControlArgs.speed;
            _camAcceleration = CamControlArgs.acceleration;
            _camHeightAdjustmentMaxSpeed = CamControlArgs.camHeightAdjustmentMaxSpeed;
            _camHeight = CamControlArgs.camHeight;
        }

        // Local constants
        [SerializeField] private float _camHeightAdjustmentMaxSpeed = 60.0f;
        [SerializeField] private float _camAcceleration = 1.0f;
        [SerializeField] private float _camHeight = 20.0f;
        ...
        void AjustPosition()
        {
            ...
            _haSpeed += Min(Abs(tempSpeed), _camHeightAdjustmentMaxSpeed) * deltaSign;
